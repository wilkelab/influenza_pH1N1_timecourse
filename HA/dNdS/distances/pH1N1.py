...
imagefiles = ["images/trimer_%02i.png" % (i+1) for i in range(imgnum)]
...
HA = HA.fx(vfx.resize, width=int(0.3*W)).set_pos(("center", "center"))
...
text = concatenate_videoclips(label_clips).set_pos((0.65*W, 0.1*H))

frames_per_second = 24

legend = (ImageClip("scale.png").set_pos((0.65*W, 0.25*H))).set_duration(text.duration)
